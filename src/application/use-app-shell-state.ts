...
export function useAppShellState({
  ...
  const sidebarPaneProps: ComponentProps<typeof AppSidebarPane> = {
    ...
    canGenerateGenTab: controller.canGenerateGenTab,
    genTabBlockedReason: controller.genTabBlockedReason,
    hasConnectedLobster,
    isModelSwitching: controller.isModelSwitching,
    isThinking: controller.isThinking,
    lobsterLabel,
    ...
    selectedComposerSkill: controller.selectedComposerSkill,
    primaryGenTabSourceTab: controller.primaryGenTabSourceTab,
    selectedReferenceIds: controller.selectedReferenceIds,
    totalGenTabSourcePageCount: controller.totalGenTabSourcePageCount,
    sidebarWidth,
